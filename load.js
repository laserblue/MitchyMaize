/* This file is from Making Friends and loads in a map and a spritesheet. There are some coding style differences that need to be taken into account but I want to replace the 'stars' picture for the Game state with a map and a sprite.
*/
...
Game.Load.prototype = {
  preload: function() {
    ...
    this.game.load.spritesheet('player','assets/images/rpg_sprite_walk.png',24, 32, 32);
